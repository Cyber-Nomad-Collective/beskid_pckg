...
public partial class Packages
{
    ...
    private void StartMetadataEdit(PackageSummaryRow package)
    {
    ...
    private void StartVersionUpload(PackageSummaryRow package)
    {
    ...
    private sealed record PublishPackageVersionResponse(bool Success, string Message, object? Data);
}